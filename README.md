...
- **Расширенные плагины v12 несовместимы** - требуется миграция на async API (16+ плагинов)
...
### **Высокий приоритет:**
- 🔥 **Продвинутые TTS движки** - Silero v3/v4, VOSK TTS (3 плагина)
- 🔥 **Портирование расширенных плагинов** - weather, media controls (16+ плагинов)
...
- [ ] **Продвинутые TTS движки** - Silero v3/v4, VOSK TTS (3 плагина)
- [ ] **Расширенные плагины** - weather, media controls (16+ плагинов)

### **Среднесрочные цели:**
- [ ] **Расширенный веб-интерфейс** - улучшенный Settings Manager
- [ ] **Docker образы для разных профилей** - headless, api, voice
- [ ] **Миграция всех 27+ плагинов** - полная совместимость функций v12 (19+ остается)
...
**V13 превращает Ирину в современную платформу с веб-интерфейсом, API экосистемой и полноценной аудио системой!**
