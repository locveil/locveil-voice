# Irene — Release Journal archive: 2026-06-15 … 2026-06-22

Frozen entries rotated out of the active [`docs/RELEASE_JOURNAL.md`](../../RELEASE_JOURNAL.md)
on 2026-07-02 (`one-active-journal` high-water rotation). Append-only history — never re-edited;
grep here when reconciliation needs this window. Newer archive: none (this is the newest);
older: [`pre-2026-06-15.md`](pre-2026-06-15.md).
